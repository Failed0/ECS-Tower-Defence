...
public class EcsBuildingDefence {
    ...
    private static void parseBugWave(Building b,String l){
        ...
        for(String bs: stringOfBugs){
            ...
            }else if(type.equals("ISB")){
                bug = new IllegalStateBug(name,level,step);
            }else if(type.equals("OBB")){
                bug = new OutOfBoundBug(name,level,step);
            }else if(type.equals(("CCB"))){
                bug = new ClassCastBug(name,level,step);
            }
